...
int tasmoclaw_mbedtls_ssl_setup_ret = 0;
int tasmoclaw_mbedtls_ssl_setup_in_len = 0;
int tasmoclaw_mbedtls_ssl_setup_out_len = 0;
int tasmoclaw_mbedtls_ssl_handshake_ret = 0;
int tasmoclaw_mbedtls_ssl_handshake_state = 0;
                      ...
                      const mbedtls_ssl_config *conf)
{
    ...
    tasmoclaw_mbedtls_ssl_setup_ret = 0;
    tasmoclaw_mbedtls_ssl_setup_in_len = (int) in_buf_len;
    tasmoclaw_mbedtls_ssl_setup_out_len = (int) out_buf_len;
...
error:
    tasmoclaw_mbedtls_ssl_setup_ret = ret;
...
cleanup:
    if (ret != 0) {
        tasmoclaw_mbedtls_ssl_handshake_ret = ret;
        tasmoclaw_mbedtls_ssl_handshake_state = ssl ? ssl->state : -1;
    }
    return ret;
}
...
int mbedtls_ssl_handshake(mbedtls_ssl_context *ssl)
{
    ...
    tasmoclaw_mbedtls_ssl_handshake_ret = 0;
    tasmoclaw_mbedtls_ssl_handshake_state = 0;
    ...
    while (ssl->state != MBEDTLS_SSL_HANDSHAKE_OVER) {
        ...
        if (ret != 0) {
            tasmoclaw_mbedtls_ssl_handshake_ret = ret;
            tasmoclaw_mbedtls_ssl_handshake_state = ssl->state;
            break;
        }
    }
